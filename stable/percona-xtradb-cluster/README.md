...
| `service.percona.headless` | if set to true creates an additional [headless](https://kubernetes.io/docs/concepts/services-networking/service/#headless-services) kubernetes service to percona| false |
