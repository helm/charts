...
| `replicaCount`            | # of replica pods for deployment                                                                                            | 1
| `deploymentStrategy`      | Deployment strategy for dashboard                                                                                           | `rollingUpdate: {maxSurge: 0, maxUnavailable: 1}, type: RollingUpdate`
