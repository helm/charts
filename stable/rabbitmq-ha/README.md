...
| `networkPolicy.enable`                              | Enable network policy                                                                                                                                                                                 | `false`                                                    |
| `networkPolicy.allowClientLabel`                    | Allow access for clients with label "rabbitmq-client: true"                                                                                                                                           | `true`                                                     |
| `networkPolicy.customConfig`                        | Add custom network policy config                                                                                                                                                                      | ``                                                         |
