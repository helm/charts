...
| `initContainer.runAsGroup`                          | Group ID for the initContainer                                                                                                                                                                        | `0`                                                        |
| `initContainer.runAsUser `                          | User ID for the initContainer                                                                                                                                                                         | `0`                                                        |
| `initContainer.runAsNonRoot `                       | Enforce non-root user ID for the container                                                                                                                                                            | `false`                                                    |
| `initContainer.skipChown `                          | don't force file permissions to  `/var/lib/rabbitmq/` and  `/etc/rabbitmq`                                                                                                                            | `false`                                                    |
