...
| `podAntiAffinityTopologyKey`                   | TopologyKey for antiaffinity, default is hostname                                                                                                                                                     | `"kubernetes.io/hostname"`                                 |
| `podAffinity`                                  | Additional pod affinity settings. This can replace pod anitaffinity entirely if you set `podAntiAffinity: ""`                                                                                         | `{}`                                                       |
