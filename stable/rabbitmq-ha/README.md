...
| `service.publishNotReadyAddresses`             | When set to true, indicates that DNS implementations must publish the IP addresses of pods that are not Ready. Useful with custom readiness check.                                                    | `false`                                                    |
