...
| `captivePortalService.enabled`                            | Install the captive portal service (needed if you want guest captive portal)                                                | `false`                  |
...
| `captivePortalService.ingress.enabled`                            | Enables Ingress (for the captive portal, the main ingress needs to be enabled for the controller to be accessible)                                                                                                       | `false`                      |
...
| `captivePortalService.ingress.hosts`                              | Ingress accepted hostnames for the captive portal                                                                                               | `chart-example.local`        |
