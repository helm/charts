...
`nodeExporter.extraHostPathMounts` | Additional node-exporter extra hostPath mounts | `[]`
...
`server.extraHostPathMounts` | Additional Prometheus server extra hostPath mounts | `[]`
