...
| `repoConfigJSON`                              | Allow Server Side Repo Config to control per-repo behaviour and what users can do in repo-level atlantis.yaml files.          | `''`    |
| `allowForkPRs`                              | Respond to pull requests from forks.                                                                                             | `false`    |
| `defaultTFVersion`                              | Default Terraform Version to use                                                                                             | `''`    |
