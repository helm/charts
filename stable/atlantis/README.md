...
| `command`                                   | Optionally override the arguments passed to the Atlantis Docker image. By default no arguments are passed which is the same as passing `["server"]`. Must be an array.                                                                                                                                  | `[]`    |
