...
| `atlantisConfig`                            | [Server Side Configuration](https://www.runatlantis.io/docs/server-configuration.html#config-file) as a raw YAML string. Configuration is stored in ConfigMap.                                                                                                                                            | n/a     |
