...
| `serverSideConfig.enabled`                  | Enable [Server Side Repo Configuration](https://www.runatlantis.io/docs/server-side-repo-config.html)                                                                                                                                                                                                     | `false` |
| `serverSideConfig.config`                   | Server Side Configuration in YAML, configuration is stored in ConfigMap                                                                                                                                                                                                                                   | n/a     |
