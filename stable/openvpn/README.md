...
When all components of the openvpn chart have started use the following script to generate a client key and config, and retrieve the newly-created config:
