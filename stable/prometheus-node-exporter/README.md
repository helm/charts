...
| `labelsOverride`                      | Override the defaults labels. You need to reflect changes into `selectorOverride`                                             | `{}`                                             |
| `selectorOverride`                    | Override selectors used to identify pods managed by this chart. Consider changing this value when `labelsOverride` is used    | `{}`                                             |
