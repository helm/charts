...
| `podSecurityPolicy.volumes`                              | Allowed volumes for FileBeat to access                                                                   | `[configMap, secret, hostPath]`                    |
| `podSecurityPolicy.runAsUser`                            | Specify allowed user to run as                                                                           | `runAsUser { rule:  mustRunAs ranges { min: 0 max: 0 }}` |
