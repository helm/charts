...
| `dashboard.service.annotations`        | Annotations for the Traefik dashboard Service definition                                                                     | `{}`                                              |
| `dashboard.ingress.annotations`        | Annotations for the Traefik dashboard Ingress definition                                                                     | `{}`                                              |
...
| `service.annotations`                  | Annotations for the Traefik Service definition                                                                               | `{}`                                              |
...
| `deployment.podAnnotations`            | Annotations for the Traefik pod definition                                                                                   | `{}`                                              |
