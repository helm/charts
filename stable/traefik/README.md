...
| `dashboard.ingress.annotations` | Annotations for the Traefik dashboard Ingress definition             | None                                      |
| `service.annotations`           | Annotations for the Traefik Service definition                       | None                                      |
| `service.labels`                | Additional labels for the Traefik Service definition                 | None                                      |
