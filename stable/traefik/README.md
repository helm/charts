...
| `deployType`                    | Deploy Traefik as Deployment or DaemonSet([official doc](https://docs.traefik.io/user-guide/kubernetes/#deploy-trfik-using-a-deployment-or-daemonset))                           | `Deployment`                            |
