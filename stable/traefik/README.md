...
| `ssl.generateTLS`                      | Generate self sign cert by Helm. If it's `true` the `defaultCerts` parameter will be ignored.                                | false                                             |
...
| `ssl.defaultCerts[].name`              | Base certificate file name                                                                                                   | `self-signed`                                     |
| `ssl.defaultCerts[].crt`               | Base64 encoded default certificate                                                                                           | A self-signed certificate                         |
| `ssl.defaultCerts[].key`               | Base64 encoded private key for the certificate above                                                                         | The private key for the certificate above         |
