...
| `deployment.containerPort.httpPort`    | Container port used for http.                                                                                                | `80`                                              |
| `deployment.containerPort.httpnPort`   | Container port used for httpn.                                                                                               | `8880`                                            |
| `deployment.containerPort.httpsPort`   | Container port used for https.                                                                                               | `443`                                             |
| `deployment.containerPort.dashboardPort`| Container port used for dashboard.                                                                                          | `8080`                                            |
