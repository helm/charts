...
| `ssl.extraCerts`                       | A list of any extra certificate/key filenames you want included in the traefik instance. You can use this in conjunction with the `secretFiles` parameter to include the certs on each traefik pod                                                                        | []         |
