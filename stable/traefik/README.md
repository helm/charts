...
| `accessLogs.filters.statusCodes        | Filter access logs by http status codes                                                                                      | `[]`                                              |
| `accessLogs.filters.retryAttempts      | Filter access logs retryAttemps                                                                                              | `false`                                           |
| `accessLogs.filters.minDuration        | Filter access logs by Minimum Duration                                                                                       | `0`                                               |
