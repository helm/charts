...
| `imageTag`                             | The version of the official Traefik image to use                                                                             | `1.7.19`                                           |
| `imagePullSecrets`                     | A list of image pull secrets (if needed)                                                                                     | None                                           |
| `deployType`                           | Deploy Traefik as Deployment or DaemonSet                                                                                    | `Deployment`                                    |
...
| `hostNetwork.enable`                   | Whether to enable hostNetwork for pods.                                                                                      | `false`                                           |
| `dnsPolicy`                            | A valid dnsPolicy for pods.                                                                                                  | `ClusterFirst`                                           |
| `net_bind_service.enabled`             | Add NET_BIND_SERVICE to securityContext.                                                                                     | `false`                                           |
