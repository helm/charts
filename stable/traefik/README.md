...
| `accessLog.enabled`             | Whether to enable Traefik's access logs                              | `false`                                   |
| `accessLog.filePath`            | The path to the log file. Logs to stdout if omitted                  | None                                      |
| `accessLog.format`              | What format the log entries should be in. Either `common` or `json`  | `common`                                  |
