...
[Basic auth](https://docs.traefik.io/user-guide/kubernetes/#basic-authentication) can be specified via `dashboard.auth.basic` as a map of usernames to passwords as below.
