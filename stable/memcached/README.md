...
This chart bootstraps a [Memcached](https://hub.docker.com/_/memcached/) statefulset on a [Kubernetes](http://kubernetes.io) cluster using the [Helm](https://helm.sh) package manager.
