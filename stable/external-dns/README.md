...
| `istio.ingressGateway`             | When using Istio, optionally specify the custom gateway instead of istio-system/istio-ingressgateway if necessary.         | `""`                                               |
...
| `sources`                          | List of resource types to monitor, possible values are fake, service, ingress or istio-gateway                             | `[service, ingress]`                               |
