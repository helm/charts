...
| `customCA.enabled`                  | For providers that allow custom CAs, enable a custom CA (optional)                                       | false                                                       |
| `customCA.content`                  | For providers that allow custom CAs, set the content of the custom CA                                    | ""                                                          |
| `customCA.mountPath`                | For providers that allow custom CAs, set the mountPath in which to mount the custom CA configuration     | "/etc/ssl/certs"                                            |
| `customCA.filename`                 | For providers that allow custom CAs, set the custom CA configuration filename                            | "ca-certificates.crt"                                       |
