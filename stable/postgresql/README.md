...
| `global.imageRegistry`                        | Override the default Docker Image registry                                                                                                                                | `docker.io`                                                   |
| `global.imageNamespace`                       | Override the default Registry Image Namespace                                                                                                                             | `bitnami`                                                     |
...
| `useOriginalRegistry`                         | Revert to the registry host defined in this chart. Useful when `global.imageRegistry` has been set.                                                                       | false                                                         |
| `useOriginalNamespace`                        | Revert to the registry namespace defined in this chart. Useful when `global.imageNamespace` has been set.                                                                 | false                                                         |
| `images.postgresql.*`                         | Settings for the PostgreSQL database docker image                                                                                                                         | `nil`                                                         |
| `images.metrics.*`                            | Settings for the metrics docker image                                                                                                                                     | `nil`                                                         |
| `images.volumePermissions.*`                  | Settings for the Init container volume-permissions docker image                                                                                                           | `nil`                                                         |
| `images.*.registry`                           | Docker Image Registry for a specific docker image, overrides `imageRegistry`                                                                                              | `nil`                                                         |
| `images.*.pullPolicy`                         | Image pull policy for a specific docker image, overrides `imagePullPolicy`                                                                                                | `nil`                                                         |
| `images.*.pullSecrets`                        | Image pull secrets for a specific docker image, gets concatenated with `global.imagePullSecrets`, `imagePullSecrets` and `images.*.pullSecrets`                           | `[]` (does not add image pull secrets to deployed pods)       |
| `images.*.namespace`                          | Image repository namespace for a specific docker image, overrides `imageNamespace`                                                                                        | `nil`                                                         |
| `images.*.name`                               | Image name                                                                                                                                                                | `postgresql`                                                  |
| `images.*.tag`                                | Image tag                                                                                                                                                                 | `{TAG_NAME}`                                                  |
| `images.*.useOriginalRegistry`                | Revert to the registry host defined for this image. Useful when `global.imageRegistry` or the chart-level `imageRegistry` setting has been set.                           | false                                                         |
| `images.*.useOriginalNamespace`               | Revert to the registry namespace defined for this image. Useful when `global.imageNamespace` or the chart-level `imageNamespace` setting has been set.                    | false                                                         |
| `images.postgresql.debug`                     | Specify if debug values should be set for the PostgreSQL database image                                                                                                   | `false`                                                       |
