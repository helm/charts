...
| `hub.tag` | The selenium hub image tag | `3.6.0` |
...
| `chromeDebug.tag` | The selenium node chrome debug tag | `3.6.0` |
...
| `firefox.tag` | The selenium node firefox tag | `3.6.0` |
...
| `firefoxDebug.tag` | The selenium node firefox debug tag | `3.6.0` |
