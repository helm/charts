...
| `hub.nodeselector` | Node label to use for scheduling of the hub | `nil` |
...
| `chrome.nodeselector` | Node label to use for scheduling of chrome images | `nil` |
...
| `chromeDebug.nodeselector` | Node label to use for scheduling of chromeDebug images | `nil` |
...
| `firefox.nodeselector` | Node label to use for scheduling of firefox images | `nil` |
...
| `firefoxDebug.nodeselector` | Node label to use for scheduling of firefoxDebug images | `nil` |
