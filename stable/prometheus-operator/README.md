...
| `prometheus.prometheusSpec.additionalScrapeConfigsAnnotations` | additionalScrapeConfigsAnnotations allows to add annotations to the kubernetes secret. This can be useful when deploying via spinnaker to disable versioning on the secret, strategy.spinnaker.io/versioned: 'false' | `{}` |
