...
| `prometheus.prometheusSpec.initContainers` | Run initContainers prior to the Prometheus container starting up | `{}` |
...
| Parameter | Description | Default |
| ----- | ----------- | ------ |
| `alertmanager.alertmanagerSpec.initContainers` | Run initContainers prior to the AlertManager container starting up | `{}` |
