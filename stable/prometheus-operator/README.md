...
| `prometheusOperator.image.tag` | Tag for prometheus operator image | `v0.30.0` |
...
| `prometheusOperator.prometheusConfigReloaderImage.tag` | Tag for config-reloader image | `v0.30.0` |
