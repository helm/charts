...
{{/*
Create a default fully qualified dependency name for the ui db.
We truncate at 63 chars because some Kubernetes name fields are limited to this (by the DNS naming spec).
*/}}
{{- define "postgres.anchore-ui-db.fullname" -}}
{{- printf "%s-%s" .Release.Name "anchore-ui-db" | trunc 63 | trimSuffix "-" -}}
{{- end -}}
