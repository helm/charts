...
| `nexusBackup.env.targetBucket`              | Google Cloud Storage bucker for backups format `gs://BACKUP_BUCKET`  | `nil`  |
...
| `cert-manager.enabled`                      | Enable cert-manager as a dependency for supplying tls cert | `false`          |
