...
| `redis.service.type`      | Redis service type "ClusterIP", "LoadBalancer" or "NodePort"                                                                                                                                             | `ClusterIP`                                                                                |
| `redis.service.clusterIP` | Redis service clusterIP value (redis.service.type must be ClusterIP)                                                                                                                                     | None                                                                                       |
| `redis.service.loadBalancerIP` | Redis service loadBalancerIP value (redis.service.type must be LoadBalancer)                                                                                                                     | not set                                                                                       |
