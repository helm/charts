...
`controller.configMap.name` | point to an existing configMap rather than creating one | ""
`controller.config` | nginx ConfigMap entries to add to created configMap | none
