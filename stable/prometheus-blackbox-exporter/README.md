...
| `serviceMonitor.defaults.additionalMetricsRelabels`   | Additional metrics relabels                                                                                                   | `{}`                                                                         |
...
| `serviceMonitor.targets.[].additionalMetricsRelabels` | Map of additional metrics relabels                                                                                            | `{{ serviceMonitor.defaults.additionalMetricsRelabels }}`
