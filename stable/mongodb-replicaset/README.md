...
| `startupProbe.initialDelaySeconds`  | Startup probe initial delay seconds                                       | `0`                                                 |
| `startupProbe.periodSeconds`        | Startup probe period seconds                                              | `10`                                                |
| `startupProbe.successThreshold`     | Startup probe success threshold                                           | `60`                                                |
| `startupProbe.timeoutSeconds`       | Startup probe timeout seconds                                             | `10`                                                |
