...
| postgresql.waitImage.repository   | Image used to wait for postgres to become ready                        | `busybox`             |
| postgresql.waitImage.tag          | Tag for image used to wait for postgres to become ready                | `latest`              |
