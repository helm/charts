...
one-to-one relation with a Kong resource.  The custom reasouces are:
kongconsumer, kongcredential, kongplugin and kongingress. For example you can
declare a Kong plugin using a custom resource like this:
