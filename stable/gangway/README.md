...
| `trustedCAEnabled`                | Should Gangway use a root CA to trust for self signed certificates at the Oauth2 URLs?  If true, you must create a file rootca.crt in this directory containing the certificate.                                | `false`                                            |
