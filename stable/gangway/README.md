...
| `trustedCAFile`                   | The filename of a root CA cert to trust for self signed certificates at the Oauth2 URLs.  If specified, the file must exist in this directory.                                                                  | `""`                                               |
