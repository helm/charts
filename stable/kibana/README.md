...
| `elasticsearch.image.repository`                   | ES Docker image                                                        | docker.elastic.co/elasticsearch/elasticsearch-oss |
| `elasticsearch.image.tag`                          | ES Docker tag                                                          | 7.1.1                                             |
| `elasticsearch.cluster.name`                       | ES cluster name                                                        | kibana                                            |
| `elasticsearch.cluster.xpackEnable`                | ES Xpack plugin enabled                                                | false                                             |
| `elasticsearch.cluster.env`                        | ES env vars                                                            |                                                   |
| `elasticsearch.client.replicas`                    | ES client replicas                                                     | 1                                                 |
| `elasticsearch.data.replicas`                      | ES data replicas                                                       | 1                                                 |
| `elasticsearch.data.terminationGracePeriodSeconds` | ES data termination grace time period                                  | 60                                                |
| `elasticsearch.master.replicas`                    | ES master replicas                                                     | 1                                                 |
