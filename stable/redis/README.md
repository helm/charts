...
| `metrics.resources.requests.memory`           | Exporter Memory resource requests                                                                                                                   | `256Mi`                                                 |
| `metrics.resources.requests.cpu`              | Exporter CPU resource requests                                                                                                                      | `100m`                                                  |
| `metrics.resources.limits.memory`             | Exporter Memory resource limits                                                                                                                     | `256Mi`                                                 |
| `metrics.resources.limits.cpu`                | Exporter CPU resource limits                                                                                                                        | `100m`                                                  |
...
| `master.resources.requests.memory`            | Redis master Memory resource requests                                                                                                               | `256Mi`                                                 |
| `master.resources.requests.cpu`               | Redis master CPU resource requests                                                                                                                  | `100m`                                                  |
| `master.resources.limits.memory`              | Redis master Memory resource limits                                                                                                                 | `256Mi`                                                 |
| `master.resources.limits.cpu`                 | Redis master CPU resource limits                                                                                                                    | `100m`                                                  |
...
| `slave.resources.requests.memory`             | Redis slave Memory resource requests                                                                                                               | `256Mi`                                                 |
| `slave.resources.requests.cpu`                | Redis slave CPU resource requests                                                                                                                  | `100m`                                                  |
| `slave.resources.limits.memory`               | Redis slave Memory resource limits                                                                                                                 | `256Mi`                                                 |
| `slave.resources.limits.cpu`                  | Redis slave CPU resource limits                                                                                                                    | `100m`                                                  |
...
| `sentinel.resources.requests.memory`          | Redis Sentinel Memory resource requests                                                                                                             | `256Mi`                                                 |
| `sentinel.resources.requests.cpu`             | Redis Sentinel CPU resource requests                                                                                                                | `100m`                                                  |
| `sentinel.resources.limits.memory`            | Redis Sentinel Memory resource limits                                                                                                               | `256Mi`                                                 |
| `sentinel.resources.limits.cpu`               | Redis Sentinel CPU resource limits                                                                                                                  | `100m`                                                  |
...
| `sysctlImage.resources.requests.memory`       | sysctlImage Init container Memory resource requests                                                                                                               | `256Mi`                                                 |
| `sysctlImage.resources.requests.cpu`          | sysctlImage Init container CPU resource requests                                                                                                                  | `100m`                                                  |
| `sysctlImage.resources.limits.memory`         | sysctlImage Init container Memory resource limits                                                                                                                 | `256Mi`                                                 |
| `sysctlImage.resources.limits.cpu`            | sysctlImage Init container CPU resource limits                                                                                                                    | `100m`                                                  |
