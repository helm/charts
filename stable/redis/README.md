...
| `master.persistence.existingClaim`                | Use an existing PVC to persist data                                                                            | `nil`                                |               |
| `master.persistence.storageClass`                 | Storage class of backing PVC                                                                                   | `generic`                            |               |
| `master.persistence.accessMode`                   | Use volume as ReadOnly or ReadWrite                                                                            | `ReadWriteOnce`                      |               |
...
x| `master.securityContext.fsGroup`                  | Group ID for the container (redis master pod)                                                                  | `1001`                               |               |
