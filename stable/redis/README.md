...
| `metrics.service.labels`                      | Extra labels to put on the metrics service                                                                                                          | {}                                                      |
...
| `master.service.labels`                       | labels for redis master service                                                                                                                     | {}                                                      |
...
| `slave.service.labels`                        | labels for redis slave service                                                                                                                      | {}                                                      |
...
| `sentinel.service.labels`                     | labels for redis sentinel service                                                                                                                   | {}                                                      |
