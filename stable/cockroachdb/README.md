...
by the StatefulSet. Use the workaround below to upgrade from chart versions
previous to 2.0.0. The following example assumes that the release name is crdb:
...
| `ImageTag`                     | Container image tag                              | `v2.1.0`                                  |
