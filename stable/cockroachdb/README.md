...
```
```
my-release-cockroachdb-0    cockroachdb/cockroach:v19.2.6
my-release-cockroachdb-1    cockroachdb/cockroach:v19.2.6
my-release-cockroachdb-2    cockroachdb/cockroach:v19.2.6
my-release-cockroachdb-3    cockroachdb/cockroach:v19.2.6
```
...
| `image.tag`                              | Container image tag                                             | `v19.2.6`                                        |
