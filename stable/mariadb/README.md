...
| `master.annotations[].key`                | key for the the annotation list item                |                                                    |
| `master.annotations[].value`              | value for the the annotation list item              |                                                    |
...
| `slave.annotations[].key`                 | key for the the annotation list item                |                                                    |
| `slave.annotations[].value`               | value for the the annotation list item              |                                                    |
