...
`metrics.service.labels`           | Additional labels for metrics service                                           | `{monitor: me}`
...
`metrics.serviceMonitor.enabled`   | Enable a prometheus-operator ServiceMonitor                                     | `false`
`metrics.serviceMonitor.namespace` | Namespace for ServiceMonitor                                                    | `nil`
`metrics.serviceMonitor.selector`  | Selector for ServiceMonitor. Default to work with the prometheus-operator chart | `{release: prometheus-operator}`
