...
| `graylog.geoip.enabled`                 | If true, Maxmind Geoip Lite will be installed to ${GRAYLOG_HOME}/geoip/GeoLite2-City.mmdb                                                               | `false`                               |
| `graylog.geoip.mmdbUri`                 | If set and geoip enabled,  Maxmind Geoip Lite will be installed from the URL you have defined to ${GRAYLOG_HOME}/geoip/GeoLite2-City.mmdb                                                               | ``                               |
