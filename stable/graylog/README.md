...
| `graylog.elasticsearch.secret.enable`   | Enable setting elasticsearch hosts from a K8s secret.                                                                                                 | `false`                               |
| `graylog.elasticsearch.secret.secretName` | K8s secret name where elasticsearch hosts will be set from.                                                                                         | `{{ graylog.fullname }}`              |
| `graylog.elasticsearch.secret.secretKey`  | K8s secret key name where elasticsearch hosts will be set from.                                                                                     | ``                                    |
| `graylog.mongodb.uri`                   | Graylog MongoDB connection string. You need to specific where data will be stored.                                                                    | ``                                    |
| `graylog.mongodb.secret.enable`         | Enable setting MongoDB URI from a K8s secret.                                                                                                         | `false`                               |
| `graylog.mongodb.secret.secretName`     | K8s secret name where MongoDB URI will be set from.                                                                                                   | `{{ graylog.fullname }}`              |
| `graylog.mongodb.secret.secretKey`      | K8s secret key name where MongoDB URI will be set from.                                                                                               | ``                                    |
