...
helm install --namespace "graylog" --name "graylog" stable/graylog
```
...
```bash
helm install --namespace "graylog" --name "mongodb" stable/mongodb-replicaset
```

To install Elasticsearch, run

```bash
helm install --namespace "graylog" --name "elasticsearch" stable/elasticsearch
```
