...
`helm install falco --set auditLog.enabled=true --set auditLog.dynamicBackend.enabled=true stable/falco`
...
```
$ helm install falco --set auditLog.enabled=true stable/falco
