...
[CodiMD](https://github.com/hackmdio/codimd) is a realtime, multiplatform collaborative markdown note editor.

## Introduction

This chart bootstraps a [CodiMD](https://github.com/hackmdio/codimd-container) deployment on a [Kubernetes](http://kubernetes.io) cluster using the [Helm](https://helm.sh) package manager.
...
`image.repository` | Name of the image to run, without the tag. | [hackmdio/hackmd](https://github.com/hackmdio/codimd-container)
`image.tag` | The image tag to use. | 1.2.1
