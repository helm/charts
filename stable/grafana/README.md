...
| `ldap.existingSecretName`          | The name of an existing secret containing the `ldap.toml` file, this must have the key `ldap-toml`. Only required if `ldap.createSecret` is `false` | `""` |
