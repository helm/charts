...
| `clusterAgent.metricsProvider.useDatadogMetrics`                  | Enable usage of DatadogMetric CRD to autoscale on arbitrary Datadog queries. You need to install the `DatadogMetric` CRD before                                                                                                                                                                                                                | `false`                                          |
