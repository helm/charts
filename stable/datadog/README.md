...
| `agents.customAgentConfig`                                   | Specify custom contents for the datadog agent config (datadog.yaml). Note the `agent.useConfigMap` needs to be set to `true` for this parameter to be taken into account.                                                                                       | `{}`                                            |
