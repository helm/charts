...
| `agents.podSecurity.privileged`                              | If true, allow privileged containers                                                                                                                                                | `False`                                         |
| `agents.podSecurity.capabilites`                             | list of allow capabilities                                                                                                                                                          | `[SYS_ADMIN, SYS_RESOURCE, SYS_ADMIN, IPC_LOCK]`|
| `agents.podSecurity.volumes`                                 | list of allow volumes types                                                                                                                                                         | `[configMap,downwardAPI,emptyDir,ostPath,secret]`|
| `agents.podSecurity.seccompProfiles`                         | List of allow seccomp profiles                                                                                                                                                      | `["*"]`                                         |
| `agents.podSecurity.apparmorProfiles`                        | List of allow apparmor profiles                                                                                                                                                     | `["*"]`                                         |
