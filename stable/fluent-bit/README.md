...
| `input.tail.exclude_path`   | Set one or multiple shell patterns separated by commas to exclude files matching a certain criteria | `/var/log/containers/kube*.log` |
