...
| `plugins.command`                    | Path to Elasticsearchs plugin command                               | `"/usr/share/elasticsearch/bin/elasticsearch-plugin"` |
| `plugins.install`                    | List of plugins which should be installed before services start     | `[]`                                                  |
