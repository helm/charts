...
| `affinity`                     | Defines affinities and anti-affinities for pods used by Kafka as defined in: https://kubernetes.io/docs/concepts/configuration/assign-pod-node/#affinity-and-anti-affinity preferences                                                                                      | `{}`                                                       |
...
| `zookeeper.affinity`                     | Defines affinities and anti-affinities for pods used by Kafka as defined in: https://kubernetes.io/docs/concepts/configuration/assign-pod-node/#affinity-and-anti-affinity preferences                                                                                      | `{}`
