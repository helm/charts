...
| `headless.port`                                  | Port to be used for the headless service.                                                           | `9092`                                                               |
...
| `brokers.command`                              | Commands to run upon broker startup                                                                                                                                      | Sets `broker.id`, then `advertised.listeners` to pod IP, including any custom `advertised.listeners` set in the `configurationOverrides` section |
