...
| `livenessProbe`                | Liveness probe config                                                                                                                            | `{ tcpSocket.port: 9092, initialDelaySeconds: 30, timeoutSeconds: 5 }`                                                          |
| `readinessProbe`               | Readiness probe config                                                                                                                           | `{ exec: ["kafka-topics", "--zookeeper", "${KAFKA_ZOOKEEPER_CONNECT}", "--list"], initialDelaySeconds: 30, timeoutSeconds: 5 }` |
