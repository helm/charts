...
> **Note**: The recalim policy for most default volume provisioners is `delete`. This means that, the persistent volume provisioned using the default provisioners will be deleted along with the data when the PVC gets deleted.
