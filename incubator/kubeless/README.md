...
$ helm installspace kubeless incubator/kubeless
```
...
```bash
$ helm install my-release --namespace kubeless incubator/kubeless
```
...
```bash
$ helm install my-release --set service.name=ui-service,service,externalPort=4000 --namespace kubeless incubator/kubeless
```
...
```bash
$ helm install my-release -f values.yaml --namespace kubeless incubator/kubeless
```
...
```bash
$ helm install my-release --set ui.enabled=true --namespace kubeless incubator/kubeless
```
